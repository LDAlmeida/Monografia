...
\begin{figure}[htb] \caption{\label{fig_teste_auto}Sucesso nos testes automatizados } \begin{center} \includegraphics[scale=0.6]{./img/tests.png} \end{center} \legend{Elaborado pelo autor desta pesquisa, 2024} \end{figure}
...
\begin{figure}[htb] \caption{\label{fig_teste_google}Avaliação Page Speed Insights} \begin{center} \includegraphics[scale=0.5]{./img/pagespeedinsights.png} \end{center} \legend{Elaborado pelo autor desta pesquisa, 2024} \end{figure}
...
\begin{figure}[htb] \caption{\label{fig_gtmetrix}Avaliação GTmetrix} \begin{center} \includegraphics[scale=0.35]{./img/gtmetrix.png} \end{center} \legend{Elaborado pelo autor desta pesquisa, 2024} \end{figure}
...
\begin{figure}[htb] \caption{\label{fig_pentest}Teste do Pentest Tools} \begin{center} \includegraphics[scale=0.5]{./img/pentest.png} \end{center} \legend{Elaborado pelo autor desta pesquisa, 2024} \end{figure}
...
\begin{figure}[htb] \caption{\label{fig_immuniweb}Teste do Immuniweb} \begin{center} \includegraphics[scale=0.5]{./img/immuniweb.png} \end{center} \legend{Elaborado pelo autor desta pesquisa, 2024} \end{figure}
